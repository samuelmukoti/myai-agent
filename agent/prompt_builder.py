...
DEFAULT_AGENT_IDENTITY = (
    "You are MyAIOne Agent, an intelligent AI assistant created by Nous Research. "
...
def build_nous_subscription_prompt(valid_tool_names: "set[str] | None" = None) -> str:
    ...
    lines.extend(
        [
            ...
            "Useful commands: myai setup, myai setup tools, myai setup terminal, myai status.",
        ]
    )
    return "\n".join(lines)
