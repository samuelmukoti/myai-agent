"""
Cron job scheduling system for MyAIOne Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    myai gateway install    # Install as a user service
    sudo myai gateway install --system  # Linux servers: boot-time system service
    myai gateway            # Or run in foreground
