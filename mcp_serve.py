"""
MyAIOne MCP Server — expose messaging conversations as MCP tools.
...
class EventBridge:
    ...
    This is the MyAIOne equivalent of OpenClaw's WebSocket gateway bridge.
...
def create_mcp_server(event_bridge: Optional[EventBridge] = None) -> "FastMCP":
    """Create and return the MyAIOne MCP server with all tools registered."""
...
def run_mcp_server(verbose: bool = False) -> None:
    """Start the MyAIOne MCP server on stdio."""
    if not _MCP_SERVER_AVAILABLE:
        print(
