...
def format_banner_version_label() -> str:
    ...
    base = f"MyAIOne Agent v{VERSION} ({RELEASE_DATE})"
...
def build_welcome_banner(console: Console, model: str, cwd: str,
    ...
    left_lines.append(f"[{accent}]{model_short}[/]{ctx_str} [dim {dim}]·[/] [dim {dim}]MyAIOne[/]")
    ...
    agent_name = _skin_branding("agent_name", "MyAIOne Agent")
