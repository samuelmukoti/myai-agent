"""Slash command definitions and autocomplete for the MyAIOne CLI.
...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("rollback", "List or restore filesystem checkpoints", "Session",
               args_hint="[number]"),
    CommandDef("snapshot", "Create or restore state snapshots of MyAIOne config/state", "Session",
    ...
    CommandDef("update", "Update MyAIOne Agent to the latest version", "Info",
               gateway_only=True),
...
class SlashCommandCompleter(Completer):
    ...
    def get_completions(self, document, complete_event):
        ...
        try:
            from myai_cli.plugins import get_plugin_commands
