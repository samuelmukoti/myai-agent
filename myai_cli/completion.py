...
def generate_bash(parser: argparse.ArgumentParser) -> str:
    ...
    return f"""# MyAIOne Agent bash completion
# Add to ~/.bashrc:
...
# MyAIOne Agent zsh completion
# Add to ~/.zshrc:
#   eval "$(myai completion zsh)"
...
def generate_fish(parser: argparse.ArgumentParser) -> str:
    ...
    lines: list[str] = [
        "# MyAIOne Agent fish completion",
        "# Add to your config:",
        "#   myai completion fish | source",
        "",
        ...
        "",
        "# Complete profile names after -p / --profile",
        "complete -c myai -f -s p -l profile"
