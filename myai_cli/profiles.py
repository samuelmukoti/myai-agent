...
_PROFILE_DIRS = [
    ...
    # See myai_constants.get_subprocess_home() and issue #4426.
    "home",
]
...
def seed_profile_skills(profile_dir: Path, quiet: bool = False) -> Optional[dict]:
    ...
    try:
        result = subprocess.run(
            ...
            env={**os.environ, "MYAI_HOME": str(profile_dir)},
...
def _cleanup_gateway_service(name: str, profile_dir: Path) -> None:
    ...
    # Temporarily set MYAI_HOME so _profile_suffix resolves correctly
    old_home = os.environ.get("MYAI_HOME")
    try:
        os.environ["MYAI_HOME"] = str(profile_dir)
        from myai_cli.gateway import get_service_name, get_launchd_plist_path
        ...
        elif "MYAI_HOME" in os.environ:
            del os.environ["MYAI_HOME"]
