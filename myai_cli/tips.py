...
TIPS = [
    ...
    "myai mcp serve runs Hermes itself as an MCP server for other agents.",
    ...
    "myai backup creates a zip backup of your entire Hermes home directory.",
    ...
    "myai gateway install sets up Hermes as a system service (systemd/launchd).",
    ...
    "myai acp runs Hermes as an ACP server for VS Code, Zed, and JetBrains integration.",
