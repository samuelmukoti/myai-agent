...
- The wrapper exports `MYAI_AGENT_BUNDLED_SKILLS`, `MYAI_AGENT_OPTIONAL_SKILLS`, and `MYAI_AGENT_MANAGED=homebrew` so packaged installs keep runtime assets and defer upgrades to Homebrew.
