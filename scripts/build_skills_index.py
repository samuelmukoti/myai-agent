#!/usr/bin/env python3
"""Build the MyAIOne Skills Index — a centralized JSON catalog of all skills.
...
# Ensure MYAI_HOME is set (needed by tools/skills_hub.py imports)
os.environ.setdefault("MYAI_HOME", os.path.join(os.path.expanduser("~"), ".hermes"))
...
def main():
    print("Building MyAIOne Skills Index...", flush=True)
