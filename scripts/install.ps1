# ============================================================================
# MyAIOne Agent Installer for Windows
# ============================================================================
# Installation script for Windows (PowerShell).
# Uses uv for fast Python provisioning and package management.
#
# Usage:
#   irm https://raw.githubusercontent.com/samuelmukoti/myai-agent/main/scripts/install.ps1 | iex
#
...
function Write-Banner {
    ...
    Write-Host "│             ⚕ MyAIOne Agent Installer                   │" -ForegroundColor Magenta
    Write-Host "├─────────────────────────────────────────────────────────┤" -ForegroundColor Magenta
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/samuelmukoti/myai-agent/main/scripts/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
