...
#
# Usage:
#   irm https://raw.githubusercontent.com/melivo/myaione-agent/main/scripts/install.ps1 | iex
#
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/melivo/myaione-agent/main/scripts/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
