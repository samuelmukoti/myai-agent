...
const DEFAULT_REPLY_PREFIX = '⚕ *MyAIOne Agent*\n────────────\n';
...
async function startSocket() {
  ...
  sock = makeWASocket({
    ...
    browser: ['MyAIOne Agent', 'Chrome', '120.0'],
  ...
  sock.ev.on('messages.upsert', async ({ messages, type }) => {
    ...
    for (const msg of messages) {
      ...
      // Ignore MyAIOne's own reply messages in self-chat mode to avoid loops.
