...
```bash
python3 -m pyfiglet "MYAI" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=MYAI&font=Slant" | boxes -d stone
```
