...
Built for [MyAIOne Agent](https://github.com/samuelmukoti/myai-agent). Usable in any coding agent. Canonical source lives here; synced to [`samuelmukoti/myai-agent/skills/creative/ascii-video`](https://github.com/samuelmukoti/myai-agent/tree/main/skills/creative/ascii-video) via PR.
