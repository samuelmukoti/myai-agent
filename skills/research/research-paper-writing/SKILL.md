...
## MyAIOne Agent Integration

This skill is designed for the MyAIOne agent. It uses MyAIOne tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other MyAIOne skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.myai/plans/` | `skill_view("plan")` |
