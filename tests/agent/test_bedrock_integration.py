...
Note: Tests that import ``myai_cli.auth`` or ``myai_cli.runtime_provider``
...
class TestResolveProvider:
    ...
    def test_explicit_bedrock_resolves(self, monkeypatch):
        ...
        from myai_cli.auth import resolve_provider
    ...
    def test_auto_detect_with_aws_credentials(self, monkeypatch):
        ...
        with patch("myai_cli.auth._load_auth_store", return_value={}):
...
class TestRuntimeProvider:
    ...
    def test_bedrock_runtime_resolution(self, monkeypatch):
        ...
        with patch("myai_cli.runtime_provider.resolve_provider", return_value="bedrock"), \
             patch("myai_cli.runtime_provider._get_model_config", return_value={"provider": "bedrock"}):
    ...
    def test_bedrock_runtime_no_credentials_raises_on_auto_detect(self, monkeypatch):
        ...
        with patch("myai_cli.runtime_provider.resolve_provider", return_value="bedrock"), \
             patch("myai_cli.runtime_provider._get_model_config", return_value={"provider": "bedrock"}), \
             patch("myai_cli.runtime_provider.resolve_requested_provider", return_value="auto"), \
...
class TestProvidersModule:
    """Verify bedrock is wired into myai_cli/providers.py."""

    def test_bedrock_alias_in_providers(self):
        from myai_cli.providers import ALIASES
    ...
    def test_bedrock_transport_mapping(self):
        from myai_cli.providers import TRANSPORT_TO_API_MODE
