"""Tests for myai_cli/completion.py — shell completion script generation."""
...
from myai_cli.completion import _walk, generate_bash, generate_zsh, generate_fish
...
def _make_parser() -> argparse.ArgumentParser:
    ...
    p = argparse.ArgumentParser(prog="myai")
...
class TestGenerateFish:
    def test_disables_file_completion(self):
        ...
        assert "complete -c myai -f" in out
...
class TestSubcommandDrift:
    def test_SUBCOMMANDS_covers_required_commands(self):
        ...
        """
        import inspect
        from myai_cli.main import _coalesce_session_name_args
