"""Comprehensive tests for myai_cli.profiles module.
...
def profile_env(tmp_path, monkeypatch):
    ...
    * Creates the bare-minimum ~/.hermes directory.
    ...
    monkeypatch.setenv("MYAI_HOME", str(default_home))
    return tmp_path
...
class TestDeleteProfile:
    ...
    def test_removes_directory(self, profile_env):
        ...
        with patch("myai_cli.profiles._cleanup_gateway_service"):
...
class TestRenameProfile:
    ...
    def test_renames_directory(self, profile_env):
        ...
        with patch("myai_cli.profiles.check_alias_collision", return_value="skip"):
...
class TestEdgeCases:
    ...
    def test_gateway_running_check_with_pid_file(self, profile_env):
        ...
        from myai_cli.profiles import _check_gateway_running
        tmp_path = profile_env
        default_home = tmp_path / ".hermes"
