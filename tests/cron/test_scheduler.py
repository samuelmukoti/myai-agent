...
class TestRunJobSessionPersistence:
    ...
    def test_run_job_sets_auto_delivery_env_from_dotenv_home_channel(self, tmp_path, monkeypatch):
        ...
        monkeypatch.delenv("TELEGRAM_HOME_CHANNEL", raising=False)
        monkeypatch.delenv("MYAI_CRON_AUTO_DELIVER_PLATFORM", raising=False)
        monkeypatch.delenv("MYAI_CRON_AUTO_DELIVER_CHAT_ID", raising=False)
        monkeypatch.delenv("MYAI_CRON_AUTO_DELIVER_THREAD_ID", raising=False)
        ...
        class FakeAgent:
            ...
            def run_conversation(self, *args, **kwargs):
                seen["platform"] = os.getenv("MYAI_CRON_AUTO_DELIVER_PLATFORM")
                seen["chat_id"] = os.getenv("MYAI_CRON_AUTO_DELIVER_CHAT_ID")
        ...
        assert os.getenv("MYAI_CRON_AUTO_DELIVER_PLATFORM") is None
        assert os.getenv("MYAI_CRON_AUTO_DELIVER_CHAT_ID") is None
        assert os.getenv("MYAI_CRON_AUTO_DELIVER_THREAD_ID") is None
        fake_db.close.assert_called_once()
