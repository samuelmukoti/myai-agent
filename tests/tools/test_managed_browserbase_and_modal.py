...
def _enable_managed_nous_tools(monkeypatch):
    ...
    myai_cli.auth and myai_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("myai_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("myai_cli.models.check_nous_free_tier", lambda: False)
