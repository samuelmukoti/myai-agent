...
Architecture:
    ~/.myai/checkpoints/{sha256(abs_dir)[:16]}/   — shadow git repo
...
CHECKPOINT_BASE = get_myai_home() / "checkpoints"
...
_GIT_TIMEOUT: int = max(10, min(60, int(os.getenv("MYAI_CHECKPOINT_TIMEOUT", "30"))))
