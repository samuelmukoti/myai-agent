"""
Cron job management tools for MyAIOne Agent.
...
def _origin_from_env() -> Optional[Dict[str, str]]:
    ...
    origin_platform = get_session_env("MYAI_SESSION_PLATFORM")
    origin_chat_id = get_session_env("MYAI_SESSION_CHAT_ID")
    if origin_platform and origin_chat_id:
        thread_id = get_session_env("MYAI_SESSION_THREAD_ID") or None
        if thread_id:
            logger.debug(
        ...
        return {
            ...
            "chat_name": get_session_env("MYAI_SESSION_CHAT_NAME") or None,
            "thread_id": thread_id,
        }
    return None
...
def check_cronjob_requirements() -> bool:
    ...
    """
    return bool(
        os.getenv("MYAI_INTERACTIVE")
        or os.getenv("MYAI_GATEWAY_SESSION")
        or os.getenv("MYAI_EXEC_ASK")
    )
