...
hermes cron create "0 2 * * *" \
  "You are a project manager triaging the samuelmukoti/myai-agent GitHub repo.

1. Run: gh issue list --repo samuelmukoti/myai-agent --state open --json number,title,labels,author,createdAt --limit 30
...
hermes cron create "0 9 * * 1" \
  "Scan the samuelmukoti/myai-agent repo for documentation drift.

1. Run: gh pr list --repo samuelmukoti/myai-agent --state merged --json number,title,files,mergedAt --limit 30
