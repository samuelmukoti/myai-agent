...
```bash
pip install git+https://github.com/samuelmukoti/myai-agent.git
```

Or with [uv](https://docs.astral.sh/uv/):

```bash
uv pip install git+https://github.com/samuelmukoti/myai-agent.git
```

You can also pin it in your `requirements.txt`:

```text
myaione-agent @ git+https://github.com/samuelmukoti/myai-agent.git
```
