...
|---------|---------|---------|
| Quiet period | `MYAI_FEISHU_TEXT_BATCH_DELAY_SECONDS` | 0.6s |
| Max messages per batch | `MYAI_FEISHU_TEXT_BATCH_MAX_MESSAGES` | 8 |
| Max characters per batch | `MYAI_FEISHU_TEXT_BATCH_MAX_CHARS` | 4000 |
...
| Setting | Env Var | Default |
|---------|---------|---------|
| Quiet period | `MYAI_FEISHU_MEDIA_BATCH_DELAY_SECONDS` | 0.8s |
...
| Setting | Env Var | Default |
|---------|---------|---------|
| Cache size | `MYAI_FEISHU_DEDUP_CACHE_SIZE` | 2048 entries |
...
| `MYAI_FEISHU_DEDUP_CACHE_SIZE` | — | `2048` | Max deduplicated message IDs to track |
| `MYAI_FEISHU_TEXT_BATCH_DELAY_SECONDS` | — | `0.6` | Text burst debounce quiet period |
| `MYAI_FEISHU_TEXT_BATCH_MAX_MESSAGES` | — | `8` | Max messages merged per text batch |
| `MYAI_FEISHU_TEXT_BATCH_MAX_CHARS` | — | `4000` | Max characters merged per text batch |
| `MYAI_FEISHU_MEDIA_BATCH_DELAY_SECONDS` | — | `0.8` | Media burst debounce quiet period |
